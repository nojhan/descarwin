...
# IPC6
#sge_submit_array_ipc "/tools/pddl/ipc/ipc2008/tempo-sat/elevators-strips/" 0 $runs "tempo-sat"
...
#sge_submit_array_ipc "/tools/pddl/ipc/IPC3/Tests2/Rovers/SimpleTime" "--sequential=0" $runs "STRIPS"
...
#sge_submit_array_ipc "/tools/pddl/ipc/IPC3/Tests1/ZenoTravel/SimpleTime" "--sequential=0" $runs "TEMPORAL"
...
#sge_submit_array_ipc "/tools/pddl/ipc/IPC3/Tests2/Satellite/SimpleTime" "--sequential=0" $runs "STRIPS"
...
#sge_submit_array_ipc "/tools/pddl/ipc/IPC4/DOMAINS/AIRPORT/NONTEMPORAL/STRIPS" "--sequential=1" $runs "STRIPS"
...
#sge_submit_array_ipc "/tools/pddl/ipc/IPC4/DOMAINS/SATELLITE/STRIPS/STRIPS" "--sequential=1" $runs "STRIPS"
...
#sge_submit_array_ipc "/tools/pddl/ipc/IPC3/Tests2/Rovers/Strips" "--sequential=1" $runs "STRIPS"
...
#sge_submit_array_ipc "/tools/pddl/ipc/IPC3/Tests1/ZenoTravel/Strips" "--sequential=1" $runs "STRIPS"
...
#sge_submit_array_ipc "/tools/pddl/ipc/IPC3/Tests2/Satellite/Strips" "--sequential=1" $runs "STRIPS"
...
#sge_submit_array_ipc "/tools/pddl/ipc/IPC3/Tests3/FreeCell/Strips" "--sequential=1" $runs "STRIPS"

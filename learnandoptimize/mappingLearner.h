...
mappingLearner::mappingLearner(unsigned int numinput, unsigned int numoutput):num_input(numinput),num_output(numoutput)
...
double mappingLearner::train(vector<vector<double> >& inputs, vector<vector<double> >& outputs)
	{
...
void mappingLearner::run(vector<double>& input, vector<double>& output)
{
...
void mappingLearner::save(char *filename)
{
...
bool mappingLearner::load(char *filename)
{

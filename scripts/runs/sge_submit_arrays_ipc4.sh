...
function sge_submit_array_ipc()
{
	...
	if test -r $instance && test -r $domain; then
	    ...
	    cmd1="qsub -l h_rt=00:30:00 -q all.q@@ls -b y -N dae      -cwd -o $respath/data/ -e $respath/logs/ -t 1-$runs -S /bin/bash ./run_wrapper.ipc4.sh $domain $instance $respath"
...
sge_submit_array_ipc "/tools/pddl/ipc/IPC4/DOMAINS/AIRPORT/NONTEMPORAL/STRIPS" $runs "seq-sat"
...
sge_submit_array_ipc "/tools/pddl/ipc/IPC4/DOMAINS/AIRPORT/TEMPORAL/STRIPS_TEMPORAL" $runs "tempo-sat"
...
sge_submit_array_ipc "/tools/pddl/ipc/IPC4/DOMAINS/AIRPORT/TEMPORAL_TIMEWINDOWS/STRIPS_TEMPORAL_TIMEDLITERALS" $runs "tempo-sat"
...
sge_submit_array_ipc "/tools/pddl/ipc/IPC4/DOMAINS/AIRPORT/TEMPORAL_TIMEWINDOWS_COMPILED/STRIPS_TEMPORAL" $runs "tempo-sat"
...
sge_submit_array_ipc_single_domain "/tools/pddl/ipc/IPC4/DOMAINS/PIPESWORLD/NOTANKAGE_NONTEMPORAL/STRIPS" $runs "seq-sat"
...
sge_submit_array_ipc_single_domain "/tools/pddl/ipc/IPC4/DOMAINS/PIPESWORLD/TANKAGE_NONTEMPORAL/STRIPS" $runs "seq-sat"
...
sge_submit_array_ipc_single_domain "/tools/pddl/ipc/IPC4/DOMAINS/PIPESWORLD/TANKAGE_TEMPORAL/STRIPS_TEMPORAL" $runs "tempo-sat"
...
sge_submit_array_ipc "/tools/pddl/ipc/IPC4/DOMAINS/PROMELA/OPTICAL_TELEGRAPH/STRIP" $runs "seq-sat"
...
sge_submit_array_ipc "/tools/pddl/ipc/IPC4/DOMAINS/PROMELA/PHILOSOPHERS/STRIP" $runs "seq-sat"
...
sge_submit_array_ipc "/tools/pddl/ipc/IPC4/DOMAINS/PSR/SMALL/STRIPS" $runs "seq-sat"
...
sge_submit_array_ipc_single_domain "/tools/pddl/ipc/IPC4/DOMAINS/SATELLITE/STRIPS/STRIPS" $runs "seq-sat"
...
sge_submit_array_ipc_single_domain "/tools/pddl/ipc/IPC4/DOMAINS/SATELLITE/TIME/STRIPS_TEMPORAL" $runs "tempo-sat"

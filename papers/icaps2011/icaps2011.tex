...
\begin{figure}[h!]
  ...
  \caption{Relation of the feature "numbre of objects" and the parameter "mutation rate" as learned by the ANN, during evaluation on the test-set.}
\end{figure}

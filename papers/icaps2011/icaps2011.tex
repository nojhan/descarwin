...
for Evolutionary AI Planning -- $Revision: 1 $}
...
\caption{Statistics of some features per domains in the train-set. Values given are [min,max] average, standard deviation respectively.}
\end{table*} 

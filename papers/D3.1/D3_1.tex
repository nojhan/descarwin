...
\begin{figure}
 \begin{tabular}{ccc}
  ...
  \includegraphics[width=0.32\textwidth]{zeno9_Add_Exact-pareto.eps} &
  \includegraphics[width=0.32\textwidth]{zeno9s_Add_Exact-pareto.eps}\\
1 1.1 3 &
1 2 3 &
1 2.9 3
 \end{tabular}
\caption{The exact Pareto Fronts for the \MULTIZENO9 problem for different values of the cost of {\tt city2}}

...
\hline\hline
Name & \# of iterations & \# of training instances & \# of test instances &  ANN-error & quality-ratio LAO & quality-ratio ANN on train & quality-ratio of ANN test \\ 
\hline
...
\end{tabular}
\label{table:domains}
\caption{Best results according to source of hint}
\end{table*} 

...
We made a proof-of-concept of a shared-memory parallelization of the evauation
...
the tested benchmark, this speed-up being the same on all the instances. 

The dispersion of the measured times is mainly due to the
combination of the steady-state stopping criterion and to the stochastic nature
of the search, which may or may not reach a fitness plateus early. The
...
with the population size, as it has an impact on the dispersions of the

...
\thanks{This work is being partially funded by Agence Nationale de la Recherche under research contract ANR-09-COSI-002-01.}}
...
In order to permit OpenMP to  build  a  multi-threaded  algorithm  without  side
...
\begin{figure}[htpb]
  ...
  \end{center}
  \caption{Absolute speedup distributions of 11 runs of \DAEYAHSP\ according to the population size, on the both sequential elevators-12 and openstacks-17 problems, using 48 processors.}

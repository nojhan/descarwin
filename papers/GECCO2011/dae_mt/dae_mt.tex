...
We have chosen not to use this framework because we were targeting multicore
...
OpenMP\footnote{OpenMP: \url{http://www.openmp.org}}, that uses a set of compiler

...
For \ELEVATORS-12, there is no much difference between static versus dynamic and between shared and local memoization. 
...
An explanation for the poor performance of shared memoization might be that the benefit obtained when memoization is shared among individuals is lost with the bottleneck due to multiple access locking.

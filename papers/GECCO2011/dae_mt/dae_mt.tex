...
This observation meets the expected behavior and is classical when considering
the parallelization of the evaluation step of an evolutionary algorithm.
...
may be preferred, but more tests on different domains are necessary.

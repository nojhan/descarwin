...
objects, and  actions are triples of  sets of atoms:  preconditions, add effets,
...
To solve such planning tasks, several heuristic search algorithms have been proposed in the past but none of them are easily parallelizable.
...
The design of experiment is built on problems extracted from the last international planning competition\footnote{\url{http://ipc.icaps-conference.org}} with the multithreaded \DAEYAHSP\ release mapped onto a 48-core parallel machine.

% FIXME : plan de l'article
is outilined as follows. We first  describe some previous works in the fields of
parallel evolutionary  computation and AI planning, before  presenting with more
details  the  main  algorithms  on  which  our parallel  system  is  based:  the
...
simple  {\it independant  runs parallelism},  EA with  {\it  global parallelism}

...
This preliminary work opens an avenue for parallelizing any evolutionary algorithm developed with EO that would target multi-core architectures.
\end{abstract}
...
\keywords{Parallel Evolutionary Algorithm, Automated Planning, Parallel Shared-Memory, Multicore.\\} % NOT required for Proceedings
...
One important parameter is the maximum number of expanded
...
\paragraph{Specific Parallelization Issues} % (JD)

...
benchmark \ELEVATORS-12, shared  memoization  may  performs  better  for  larger
population size but that there  is  no  difference  between  static  an  dynamic
...
average.   But  the  behaviour   is   dependent   of   the   instance   and   of
...
It was expected that the decreasing time needed to  perform  a  run  would  lead
...
distribution of computation times. Moreover, the population size may seamlessly
be    chosen    small,    in    order    to    increase    computation    speed.
...
shared memoization.  As it  bring  no  improvement  on  the  other  problem,  it
may  be  prefered,  but  more  test  on  differents   domains   are   necessary.

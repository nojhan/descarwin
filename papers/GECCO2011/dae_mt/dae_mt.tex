...
\paragraph{Parallel Evolutionary Algorithms}
...
settings are run in parallel. Finally, \cite{vidal:socs2010} proposed a multicore version of the
...
%% Results
\paragraph{Speed-up by number of processors} % (CC, JD)
...
\paragraph{Speed-up by population size} % (CC, JD)

...
In order to speed up the search, a memoing mechanism has been introduced in \YAHSP\ and carefully controlled to leave memory space for \DAE.
...
This work is being partially funded by the French National Research Agency (ANR) through the COSINUS programme, under the research contract DESCARWIN (ANR-09-COSI-002-01).

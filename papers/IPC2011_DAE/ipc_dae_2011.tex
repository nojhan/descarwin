...
\cite{dae:gecco2010}. It should be noted that, due to the conditions of the competition, the parameter setting is global to all domains. In \cite{dae:gecco2010} we showed that a specific tuning for an instance provides better results and that what we would do for a real-life planning task.
...
In order to speed up the search, a memoing mechanism has been introduced in \YAHSP\ and carefully controled to leave memory space for \DAE.

...
\begin{tabular}{|l|l|c|c|c|c|c|}
  ...
  \multirow{4}*{zeno$_{add}$}       & $DAE-IBEA_{\varepsilon}$    &  2.36e-01   &  --  		& 		$\equiv$       &  	$\prec$	&  	$\prec$		   \\
   ...
   & $\equiv$      	& 	--       & 	$\equiv$ 	&	$\equiv$      \\
				    &    $DAE-NSGAII$          &    1.77e-01     & \cellcolor [gray]{0.8}$\succ$ (0.025)& 	$\equiv$ 	&	--		& $\equiv$   \\
				    &    $DAE-SPEA2$       & 1.74e-01     &  \cellcolor [gray]{0.8}$\succ$(0.01)	&	$\equiv$ 	&	$\equiv$ 		 &  --  \\
  \hline
  \multirow{4}*{zeno$_{max}$}       &  $DAE-IBEA_{\varepsilon}$ &  2.19e-01  &-- &$\equiv$  & $\equiv$  & $  \cellcolor [gray]{0.8}\succ $ (0.025)\\
	      ...
	      &  $DAE-SPEA2$		    &     4.54e-01    &\cellcolor [gray]{0.8} $\prec$ &  \cellcolor [gray]{0.8} $\prec$ & \cellcolor [gray]{0.8} $\prec$ & --   \\
   \hline
    \multirow{4}*{p01$_{add}$}   &    $DAE-IBEA_{\varepsilon}$   	    &   2.17e-001
      &    --  		& 		$\equiv$       &  	 \cellcolor [gray]{0.8}$\prec$	&   \cellcolor [gray]{0.8}	$\prec$	   \\
	      & $DAE-IBEA_{\textit{h}}$ 	    &       2.20e-01
 		 & $\equiv$      	& 	--       & 	$\equiv$ 	&	 \cellcolor [gray]{0.8}$\prec$     \\
	      &  $DAE-NSGAII$	    &     1.80e-01
 &$ \succ $ (0.05) & 	$\equiv$ 	&	--		& $\equiv$   \\
	      &  $DAE-SPEA2$	  &     1.59e-01    & \cellcolor [gray]{0.8} $ \succ $ (0.005)	& 	 \cellcolor [gray]{0.8} $ \succ $ (0.005)	&	$\equiv$ 		 &  --  \\
\hline
    \multirow{4}*{p01$_{max}$}   &  $DAE-IBEA_{\varepsilon}$   	    &   1.79e-01
      &    --  		& 		$\equiv$       &  	 \cellcolor [gray]{0.8}$\prec$  	&  	$\equiv$	   \\
	      & $DAE-IBEA_{\textit{h}}$ 	    &        1.46e-01
		 & $\equiv$      	& 	--       & 	$\equiv$ 	&	$\equiv$      \\
	      &  $DAE-NSGAII$	    &    1.26e-01  &  \cellcolor [gray]{0.8} $\succ $ (0.025) & 	$\equiv$ 	&	--		&  \cellcolor [gray]{0.8} $\succ $ (0.05)  \\
	      &  $DAE-SPEA2$	  &     1.71e-01
    &$\equiv$ 	&	$\equiv$ 	&	 \cellcolor [gray]{0.8}$\prec$  	 &  --  \\
   \hline
\end{tabular} 
...
\begin{tabular}{|l|l|c|c|c|c|c|}
   \hline
    ...
    \cline{4-7}
	      &             & 	      		& $DAE-IBEA_{\varepsilon}$ &  $DAE-IBEA_{\textit{h}}$ &  $DAE-NSGAII$ & $DAE-SPEA2$  \\
   \hline
  \multirow{4}*{zeno$_{add}$}       & $DAE-IBEA_{\varepsilon}$    &9.99e-02   &  --  & 		$\equiv$       &  	 \cellcolor [gray]{0.8}$\prec$	&  \cellcolor [gray]{0.8} 	$\prec$		   \\
				
				    &  $DAE-IBEA_{\textit{h}}$	   &  1.01e-01   & $\equiv$      	& 	--       & 	 \cellcolor [gray]{0.8}$\prec$	&	 \cellcolor [gray]{0.8}$\prec$	   \\
				    &    $DAE-NSGAII$          &    5.71e-02   & \cellcolor [gray]{0.8} $ \succ $ (0.005)& 	 \cellcolor [gray]{0.8} $ \succ $ (0.005)	&	--		& $\equiv$   \\
				    &    $DAE-SPEA2$       & 5.47e-02   &  \cellcolor [gray]{0.8} $ \succ $ (0.005)	&	 \cellcolor [gray]{0.8} $ \succ $ (0.005)	&	$\equiv$ 		 &  --  \\
  \hline
 ...
 &    --  		& 		$\equiv$       &  	$\equiv$&  	$\equiv$		   \\
  ...
  &$\equiv$  & 	$\equiv$ 	&	--		& $\equiv$   \\
	      &  $DAE-SPEA2$	  &     1.62e-01
   &$\equiv$ 	& 	 \cellcolor [gray]{0.8}$ \succ $ (0.005)	&	$\equiv$ 		 &  --  \\
\hline
    \multirow{4}*{p01$_{max}$}   &  $DAE-IBEA_{\varepsilon}$   	    &  1.53e-01
      ...
      &    --  		& 		$\equiv$       &  	$\prec$  	&  	$\equiv$	   \\
		 ...
		 & $\equiv$      	& 	--       & 	$\equiv$ 	&	$\equiv$      \\
	      &  $DAE-NSGAII$	    &   1.21e-01
  &$\equiv$  & 	$\equiv$ 	&	--		&  \cellcolor [gray]{0.8} $\succ $ (0.025) \\
	      &  $DAE-SPEA2$	  &    1.86e-01

...
(= (travel-slow-time n16 n17) 12) (= (travel-slow-time n16 n18) 20) (= (travel-slow-time n16 n19) 28) (= (travel-slow-time n16 n20) 36) (= (travel-slow-time n16 n21) 44) (= (travel-slow-time n16 n22) 52) (= (travel-slow-time n16 n23) 60) (= (travel-slow-time n16 n24) 68) (= (travel-slow-time n17 n18) 12) (= (travel-slow-time n17 n19) 20) (= (travel-slow-time n17 n20) 28) (= (travel-slow-time n17 n21) 36) (= (travel-slow-time n17 n22) 44) (= (travel-slow-time n17 n23) 52) (= (travel-slow-time n17 n24) 60) (= (travel-slow-time n18 n19) 12) (= (travel-slow-time n18 n20) 20) (= (travel-slow-time n18 n21) 28) (= (travel-slow-time n18 n22) 36) (= (travel-slow-time n18 n23) 44) (= (travel-slow-time n18 n24) 52) (= (travel-slow-time n19 n20) 12) (= (travel-slow-time n19 n21) 20) (= (travel-slow-time n19 n22) 28) (= (travel-slow-time n19 n23) 36) (= (travel-slow-time n19 n24) 44) (= (travel-slow-time n20 n21) 12) (= (travel-slow-time n20 n22) 20) (= (travel-slow-time n20 n23) 28) (= (travel-slow-time n20 n24) 36) (= (travel-slow-time n21 n22) 12) (= (travel-slow-time n21 n23) 20) (= (travel-slow-time n21 n24) 28) (= (travel-slow-time n22 n23) 12) (= (travel-slow-time n22 n24) 20) (= (travel-slow-time n23 n24) 12) 


(= (travel-fast-time n0 n4) 13) (= (travel-fast-time n0 n8) 17) (= (travel-fast-time n0 n12) 20) (= (travel-fast-time n0 n16) 22) (= (travel-fast-time n0 n20) 24) (= (travel-fast-time n0 n24) 26) 

(= (travel-fast-time n4 n8) 13) (= (travel-fast-time n4 n12) 17) (= (travel-fast-time n4 n16) 20) (= (travel-fast-time n4 n20) 22) (= (travel-fast-time n4 n24) 24) 

(= (travel-fast-time n8 n12) 13) (= (travel-fast-time n8 n16) 17) (= (travel-fast-time n8 n20) 20) (= (travel-fast-time n8 n24) 22) 

(= (travel-fast-time n12 n16) 13) (= (travel-fast-time n12 n20) 17) (= (travel-fast-time n12 n24) 20) 

(= (travel-fast-time n16 n20) 13) (= (travel-fast-time n16 n24) 17) 

(= (travel-fast-time n20 n24) 13) 

...
:condition (and (at start (not-made p1))(at start (started o5))(at start (started o22)))
...
:condition (and (at start (not-made p2))(at start (started o16)))
...
:condition (and (at start (not-made p3))(at start (started o17)))
...
:parameters ()
:duration (= ?duration 100)
:condition (and (at start (not-made p4))(at start (started o10))(at start (started o22)))
...
:condition (and (at start (not-made p5))(at start (started o18)))
...
:condition (and (at start (not-made p6))(at start (started o1))(at start (started o21))(at start (started o33)))
...
:parameters ()
:duration (= ?duration 10)
:condition (and (at start (not-made p7))(at start (started o10)))
...
:parameters ()
:duration (= ?duration 90)
:condition (and (at start (not-made p8))(at start (started o16)))
...
:parameters ()
:duration (= ?duration 10)
:condition (and (at start (not-made p9))(at start (started o31)))
...
:condition (and (at start (not-made p10))(at start (started o8))(at start (started o18))(at start (started o30)))
...
:condition (and (at start (not-made p11))(at start (started o5))(at start (started o12))(at start (started o21))(at start (started o30)))
...
:parameters ()
:duration (= ?duration 20)
:condition (and (at start (not-made p12))(at start (started o5))(at start (started o9)))
...
:parameters ()
:duration (= ?duration 40)
:condition (and (at start (not-made p13))(at start (started o11))(at start (started o19))(at start (started o23))(at start (started o30)))
...
:parameters ()
:duration (= ?duration 100)
:condition (and (at start (not-made p14))(at start (started o26))(at start (started o33)))
...
:parameters ()
:duration (= ?duration 20)
:condition (and (at start (not-made p15))(at start (started o29))(at start (started o30)))
...
:condition (and (at start (not-made p16))(at start (started o2))(at start (started o27)))
...
:parameters ()
:duration (= ?duration 50)
:condition (and (at start (not-made p17))(at start (started o8))(at start (started o19))(at start (started o30)))
...
:parameters ()
:duration (= ?duration 60)
:condition (and (at start (not-made p19))(at start (started o19)))
...
:parameters ()
:duration (= ?duration 20)
:condition (and (at start (not-made p20))(at start (started o30))(at start (started o32)))
...
:parameters ()
:duration (= ?duration 30)
:condition (and (at start (not-made p21))(at start (started o32)))
...
:parameters ()
:duration (= ?duration 10)
:condition (and (at start (not-made p22))(at start (started o25)))
...
:parameters ()
:duration (= ?duration 50)
:condition (and (at start (not-made p23))(at start (started o10)))
...
:parameters ()
:duration (= ?duration 40)
:condition (and (at start (not-made p24))(at start (started o32)))
...
:parameters ()
:duration (= ?duration 100)
:condition (and (at start (not-made p25))(at start (started o6))(at start (started o7))(at start (started o11))(at start (started o14)))
...
:parameters ()
:duration (= ?duration 90)
:condition (and (at start (not-made p26))(at start (started o15))(at start (started o17)))
...
:parameters ()
:duration (= ?duration 60)
:condition (and (at start (not-made p27))(at start (started o21))(at start (started o24)))
...
:parameters ()
:duration (= ?duration 40)
:condition (and (at start (not-made p28))(at start (started o23)))
...
:parameters ()
:duration (= ?duration 100)
:condition (and (at start (not-made p29))(at start (started o4))(at start (started o7))(at start (started o13))(at start (started o16))(at start (started o20)))
...
:parameters ()
:duration (= ?duration 40)
:condition (and (at start (not-made p30))(at start (started o28)))
...
:parameters ()
:duration (= ?duration 60)
:condition (and (at start (not-made p31))(at start (started o3))(at start (started o28)))
...
:parameters ()
:duration (= ?duration 60)
:condition (and (at start (not-made p32))(at start (started o15))(at start (started o33)))
...
:parameters ()
:duration (= ?duration 50)
:condition (and (at start (not-made p33))(at start (started o13))(at start (started o20)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o2))(at start (made p16))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o3))(at start (made p31))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o4))(at start (made p18))(at start (made p29))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o5))(at start (made p1))(at start (made p11))(at start (made p12))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o6))(at start (made p25))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o7))(at start (made p25))(at start (made p29))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o8))(at start (made p10))(at start (made p17))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o9))(at start (made p12))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o10))(at start (made p4))(at start (made p7))(at start (made p23))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o11))(at start (made p13))(at start (made p25))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o12))(at start (made p11))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o13))(at start (made p29))(at start (made p33))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o14))(at start (made p25))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o15))(at start (made p26))(at start (made p32))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o16))(at start (made p2))(at start (made p8))(at start (made p29))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o17))(at start (made p3))(at start (made p26))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o18))(at start (made p5))(at start (made p10))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o19))(at start (made p13))(at start (made p17))(at start (made p19))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o20))(at start (made p29))(at start (made p33))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o21))(at start (made p6))(at start (made p11))(at start (made p27))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o22))(at start (made p1))(at start (made p4))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o23))(at start (made p13))(at start (made p28))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o24))(at start (made p27))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o25))(at start (made p22))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o26))(at start (made p14))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o27))(at start (made p16))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o28))(at start (made p30))(at start (made p31))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o29))(at start (made p15))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o30))(at start (made p10))(at start (made p11))(at start (made p13))(at start (made p15))(at start (made p17))(at start (made p20))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o31))(at start (made p9))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o32))(at start (made p20))(at start (made p21))(at start (made p24))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o33))(at start (made p6))(at start (made p14))(at start (made p32))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
